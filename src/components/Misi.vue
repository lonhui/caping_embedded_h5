<template>
    <div id="Mise">
        <div class="Mise_child">
            <div class="title" @click="contentShow = !contentShow">
                <p>{{data.title}}</p>
                <span>{{data.coin}}</span>
                <img :src="contentShow?topIcon:bottomIcom" alt="">
            </div>
            <transition name="slide-fade">
                <div class="content" v-show="contentShow" v-html="data.content"></div>
            </transition>
        </div>    
    </div>    
</template>
